...
public class TranslateOverTime implements IAction {
    ...
    public IAction clone() {
        TranslateOverTime clone = new TranslateOverTime();
        clone.duration = duration;
        clone.elapsed = elapsed;
        clone.startTime = startTime;
        clone.endTime = endTime;
        clone.startPosX = startPosX;
        clone.startPosY = startPosY;
        clone.endPosX = endPosX;
        clone.endPosY = endPosY;
        clone.currentPosX = currentPosX;
        clone.currentPosY = currentPosY;
        clone.done = done;
        return clone;
    }
}
